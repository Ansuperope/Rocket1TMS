// PLEASE TEST THE mainTransmitter_RMC_GGA.ino code first!
// This code is the updated version of the main transmitter code
// It does the following:
//  1. Display RMC and GGA to main reciever (not gun)
//  2. Save HDC, DSP and all nmea senteces to SD card

// Serial 7 = main GPS
// Serial 2 = lora
// Network 18
// Sending at Address 2

// Known bugs:
//  HDC, DPS files will probably display 0 for time because i was trying to use custom
// time but I decided to scrap it and fixed it on the new code (but havent tested it)
